        ...
        if self.status == "Get on":
            if -1 <= self.y <= 1:
                ...
                if self.x-self.tx > 0:
                    ...
                    if self.y == self.ty:
                        self.status = "Wait"
                        seats[get_seat_id(self)].is_available = False
...
agents = [
    ...
    Passenger(4, -5, -13, "Down", 5, "Get off"),
    Passenger(5, -5, -14, "Down", 5, "Get off"),
    Passenger(6, -5, -15, "Down", 5, "Get off"),
    Passenger(7, -5, -16, "Down", 5, "Get off"),
